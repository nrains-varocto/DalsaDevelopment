...
namespace Varocto.Cameras
{
    ...
    public class SaperaCameraManager
    {
        ...
        /// </summary>
        /// 
        string lsoConfigFile = "C:\\development\\Devices\\Dalsa\\Camera Files\\T_Test_10-bits_Default.ccf";
        ...
        public SaperaCameraManager()
        {
            ...
            lsoCamera = new SpyderThree(cameraLinkServer, lsoConfigFile, 0);
        }
